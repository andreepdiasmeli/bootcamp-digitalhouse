...
public class OrderDTO {
    ...
    public OrderDTO(Long orderId, List<OrderItemDTO> orderItems, BigDecimal totalAmount, Long tableId) {
    ...
    public static OrderDTO toDTO(Order order) {
        ...
        return new OrderDTO(order.getId(), orderItems, order.getTotalAmount(), order.getTable().getId());
    }
